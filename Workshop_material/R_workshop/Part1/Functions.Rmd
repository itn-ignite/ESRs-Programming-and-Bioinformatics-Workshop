...
### Solution of the pi exercise:  

 - Estimate the value of the number pi by randomly generating 1000000 points inside a square and checking whether they fall within a circle inscribed in that square.     
...
codeWrap <- function(someSeed=sample(1:1000)){
     ...
     sumOfSquares <- (x^2+y^2)
     piEvaluated <- mean(sumOfSquares<1)*4
     return(abs(pi/piEvaluated-1)*100)
}
codeWrap(1234)
codeWrap(555)
codeWrap()
